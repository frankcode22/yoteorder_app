   ...
   // console.log(productsList1)
    return (
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
         ...
         {/* {!isLoading &&<button type="submit"  class="btn btn-primary btn-block float-end my-2"><i class="fas fa-save"></i><span> Save Seleted </span></button>
  ...
  {isLoading &&
    ...
    <span class="visually-hidden">Loading...</span>
       ...
       <div class="col-xl-3 col-lg-12">
        ...
        <ProductCardCommon  product={product} searchTerm={searchTerm} startquantity={startquantity} setStartQuantity={setStartQuantity} handleQuantityChange={cart.handleQuantityChange}  handleInputChange={cart.handleInputChange}></ProductCardCommon>
