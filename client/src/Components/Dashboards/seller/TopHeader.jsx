  ...
  return (
    ...
    <div class="main-header-left ">
        ...
        <div class="responsive-logo">
            <Link to='/home_retailer' class="header-logo"><img src="assets/img/brand/logo_c.jpeg" class="logo-11"/></Link>
            <Link to='/home_retailer' class="header-logo"><img src="assets/img/brand/logo_c.jpeg" class="logo-1"/></Link>
        </div>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="main-message-list chat-scroll">
                                ...
                                <a href="mail.html" class="p-3 d-flex border-bottom">
                                    ...
                                    <div class="wd-90p">
                                        <div class="d-flex">
                                            <h5 class="mb-1 name">{authState.first_name}</h5>
