...
function SideMenu() {
  ...
  return (
    ...
    <ul class="side-menu ">
        <li class="slide">
            <a class="side-menu__item" href="/supplier_home"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Home</span></a>
        </li>
        ...
        <li class="slide">
        <a href='/new_orders' class="side-menu__item"><i class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Orders</span></a>
        </li>
        ...
        <li class="slide">
        <a href='/my_stores' class="side-menu__item"><i class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Stores</span></a>
        </li>

        <li class="slide">
       
        <a href='/engagements'class="side-menu__item"><i class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Engagements</span></a>
    </li>
    ...
    <li class="slide">
       ...
       <a href='#'class="side-menu__item"><i class="side-menu__icon fe fe-bell"></i><span class="side-menu__label">Notifications</span></a>
        </li>
