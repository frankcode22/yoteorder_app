  ...
  return (
    ...
    <div class="main-header-left ">
        ...
        <div class="responsive-logo">
            <a href="/home_admin" class="header-logo"><img src="assets/img/brand/logo_c.jpeg" class="logo-11"/></a>
            <a href="/home_admin" class="header-logo"><img src="assets/img/brand/logo_c.jpeg" class="logo-1"/></a>
        </div>
