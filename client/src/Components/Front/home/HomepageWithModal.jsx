...
import SearchModalNew from './SearchModalNew';
...
function HomepageWithModal(props) {
   ...
   // let [showSecret, setShowSecret] = useState(0)
    ...
    const [showOnLoadModal, setShowOnLoadModal] = useState(false);

    const [showErrorModal, setShowErrorModal] = useState(false);

    const [showManualSearchModal, setShowManualSearchModal] = useState(true);
...
<div class="demo-screen-headline main-demo main-demo-1 spacing-top overflow-hidden" id="home" style={{ width: '100%',
    ...
    <div class="container px-sm-0">
        ...
        <div class="input-group">
                                                    <input type="text" class="form-control" value={pname} onChange={(event) => {
