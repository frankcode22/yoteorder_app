                  ...
                  <div class="count-down row">
                      <div class="col-lg-3 countdown">
                          <div class="countdown bg-primary-gradient p-3 mb-1">
                              <span class="days text-white">1</span>
                              <span class="text-white">Search Product</span>
                          </div>
                      </div>
                      <div class="col-lg-3 countdown">
                          <div class="countdown bg-success-gradient p-3 mb-1">
                              <span class="hours text-white">2</span>
                              <span class="text-white">Select Vendor</span>
                          </div>
                      </div>

                      <div class="col-lg-3 countdown">
                          <div class="countdown bg-warning-gradient p-3 mb-1">
                              <span class="minutes text-white">3</span>
                              <span class="text-white">Provide Your details</span>
                          </div>
                      </div>
                      <div class="col-lg-3 countdown">
                          <div class="countdown bg-info-gradient p-3 mb-1">
                              <span class="seconds text-white">4</span>
                              <span class="text-white">Relax and wait the delivery</span>
                          </div>
                      </div>
                  </div>
              </div>
