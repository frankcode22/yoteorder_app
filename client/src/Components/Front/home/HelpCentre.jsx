                    ...
                    <Link class="side-menu__item" data-bs-toggle="slide" to="/helpcentre"><span
                        ...
                        <li class="slide onmobile">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#Contact"><span
                                    class="side-menu__label"><i class="icon icon-login" data-bs-toggle="tooltip" title="" data-bs-original-title="icon-login" aria-label="icon-login" aria-describedby="tooltip377007"></i>Get Started</span></a>
                        </li>
...
<div class="demo-screen-headline main-demo main-demo-1 spacing-top overflow-hidden" id="home" style={{ width: '100%',
    height: 'auto',
    background: 'url("assets/images/brand/pata_mtaani_1.jpg") top center',
    ...
    <div class="container px-sm-0">
        ...
        <div class="row mb-5 justify-content-center text-center">
            <div class="col">
                <h1 class="font-weight-bold mb-0" style={{color:'white'}}>Sell, Buy and Order anything mtaani!</h1>
...
{/**<SearchModal latitude={latitude} longitude={longitude} show={show} searchItem={searchItem}/> */}
  ...
  <Button variant="primary" onClick={handleClose}>
    Save Changes
                                              ...
                                              <Modal class="modal fade" show={showVideoModal}>

                                              <Modal.Header>
                                                  <Modal.Title>Account Set Up</Modal.Title>
                                              </Modal.Header>
                                              <Modal.Body class="modal-body text-center p-4 pb-5">
            ...
            <div class="card-body">
                <div class="item-box text-center">
                    ...
                    <span class="icons"><i class="ri-mail-send-line"></i></span>
                        ...
                        <p class="text-muted mb-0">infor@patamtaani.com or frankcode20@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
