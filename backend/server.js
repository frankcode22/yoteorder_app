...
require("./src/routes/Retailers")(app);
...
require("./src/routes/RetailerSales")(app);
...
require("./src/routes/Suppliers")(app);

require("./src/routes/SupplyStores")(app);


require("./src/routes/RetailerProductCategories")(app);

require("./src/routes/BusinessEngagements")(app);
