module.exports = (sequelize, DataTypes) => {
    const Users = sequelize.define("Users", {
     ...
     Users.associate = (models) => {
      ...
      Users.hasMany(models.Business, { foreignKey: "UserId" }) // If only one portfolio per user

      models.Business.belongsTo(Users);

      
      Users.hasMany(models.Bookings, { foreignKey: "UserId" }) // If only one portfolio per user

      models.Bookings.belongsTo(Users);


      Users.hasMany(models.ServiceTypes, { foreignKey: "UserId" }) // If only one portfolio per user

      models.ServiceTypes.belongsTo(Users);


      Users.hasMany(models.ServiceTypeSubcategories, { foreignKey: "UserId" }) // If only one portfolio per user

      models.ServiceTypeSubcategories.belongsTo(Users);


      Users.hasMany(models.Notifications, { foreignKey: "UserId" }) // If only one portfolio per user
      ...
      Users.hasMany(models.Suppliers, { foreignKey: "UserId" }) // If only one portfolio per user

      models.Suppliers.belongsTo(Users);


      Users.hasMany(models.Retailers, { foreignKey: "UserId" }) // If only one portfolio per user

      models.Retailers.belongsTo(Users);


      
      Users.hasMany(models.RetailerProductCategories, { foreignKey: "UserId" }) // If only one portfolio per user

      models.RetailerProductCategories.belongsTo(Users);
