...
module.exports = (app) => {
    ...
    const {Services,Business,ServiceTypes,RetailerProductCategories,ServiceTypeSubcategories,Users}=require("../models");
    ...
    let status='available'
      ...
      const service_t= await  RetailerProductCategories.create({
    ...
    router.get("/mycategories",validateToken,async(req,res)=>{

        const item_list = await RetailerProductCategories.findAll({ where: { UserId: req.user.id }});
      ...
      router.get("/bestRated", async (req, res) => {
        ...
        const best_rated = await RetailerProductCategories.findAll();
    ...
    router.get("/getbyId/:sId", async (req, res) => {
      ...
      const service_ = await RetailerProductCategories.findOne({ where: { id: id },include: [Business]
       });
      res.json(service_);
    });
    ...
    app.use('/api/retailerproductcat', router);
