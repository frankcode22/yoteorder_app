...
router.put("/savecustomerdetails/:oId", async (req, res) => {
  ...
  const update_order = await Orders.update({customer_phone_no,customer_name,request_type},{ where: { orderId: req.params.oId}});
